...
- C# 12 / .NET 9 + ABP Framework (IRepository, ApplicationService, UnitOfWorkManager), EF Core 9, NSubstitute (tests), Shouldly (tests) (feat/023-persist-qa-records)
- PostgreSQL; all Q&A tables already exist and are migrated (feat/023-persist-qa-records)
...
## Recent Changes
- feat/023-persist-qa-records: Added C# 12 / .NET 9 + ABP Framework (IRepository, ApplicationService, UnitOfWorkManager), EF Core 9, NSubstitute (tests), Shouldly (tests)
