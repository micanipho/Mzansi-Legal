...
namespace backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MzansiCategories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Name = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    LocalizedLabels = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MzansiCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "MzansiLegalDocuments",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Title = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    ShortName = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: true),
                    ActNumber = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: true),
                    Year = table.Column<int>(type: "integer", nullable: false),
                    FullText = table.Column<string>(type: "text", nullable: true),
                    OriginalPdfPath = table.Column<string>(type: "character varying(512)", maxLength: 512, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MzansiLegalDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MzansiLegalDocuments_MzansiCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SectionNumber = table.Column<string>(type: "character varying(32)", maxLength: 32, nullable: true),
                    SectionTitle = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MzansiDocumentChunks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MzansiDocumentChunks_MzansiLegalDocuments_LegalDocumentId",
                        column: x => x.LegalDocumentId,
                        principalTable: "MzansiLegalDocuments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });

            migrationBuilder.CreateTable(
                name: "MzansiChunkEmbeddings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MzansiChunkEmbeddings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MzansiChunkEmbeddings_MzansiDocumentChunks_DocumentChunkId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MzansiChunkEmbeddings_DocumentChunkId",
                table: "MzansiChunkEmbeddings",
                column: "DocumentChunkId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MzansiDocumentChunks_LegalDocumentId",
                table: "MzansiDocumentChunks",
                column: "LegalDocumentId");

            migrationBuilder.CreateIndex(
                name: "IX_MzansiLegalDocuments_CategoryId",
                table: "MzansiLegalDocuments",
                column: "CategoryId");
        }
