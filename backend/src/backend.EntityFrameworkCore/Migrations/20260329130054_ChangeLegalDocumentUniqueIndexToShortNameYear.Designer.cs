...
namespace backend.Migrations
{
    ...
    [Migration("20260329130054_ChangeLegalDocumentUniqueIndexToShortNameYear")]
    partial class ChangeLegalDocumentUniqueIndexToShortNameYear
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Domains.LegalDocuments.DocumentChunk", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("backend.Domains.LegalDocuments.ChunkEmbedding", b =>
                {
                    b.HasOne("backend.Domains.LegalDocuments.DocumentChunk", "Chunk")
                        .WithOne("Embedding")
                        .HasForeignKey("backend.Domains.LegalDocuments.ChunkEmbedding", "ChunkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Domains.LegalDocuments.DocumentChunk", b =>
                {
                    b.HasOne("backend.Domains.LegalDocuments.LegalDocument", "Document")
                        .WithMany("Chunks")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("backend.Domains.LegalDocuments.LegalDocument", b =>
                {
                    b.HasOne("backend.Domains.LegalDocuments.Category", "Category")
